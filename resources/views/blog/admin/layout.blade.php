...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="/img/u0UVYy3oKYg.jpg" class="logo">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/img/2020-09-15 11-28-43.png" class="user-image" alt="User Image">
                            <span class="hidden-xs">Vadim Zabeyvorota</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="/img/2020-09-15 11-28-43.png" class="img-circle" alt="User Image">

                                <p>
                                    Vadim Zabeyvorota - Web Developer
