                ...
                <div class="col-md-8">
                    <article class="post">
                        ...
                        <div class="post-content">
                            <header class="entry-header text-center text-uppercase">
                                <h6><a href="{{route('post.category',$post->category->slug)}}"> {{$post->getCategoryTitle()}}</a></h6>
                            ...
                            @if($post->hasPrevious())
                                <div class="single-blog-box">
                                    <a href="{{route('post.show',$post->getPrevious()->slug)}}">
                                        <img src="{{$post->getPreviousImage()}}" alt="">

                                        <div class="overlay">

                                            <div class="promo-text">
                                                <p><i class=" pull-left fa fa-angle-left"></i></p>
                                                <h5>{{$post->getPreviousTitle()}}</h5>
                                            </div>
                                        </div>
                                ...
                                @if($post->hasNext())
                                    <div class="single-blog-box">
                                        <a href="{{route('post.show',$post->getNext()->slug)}}">
                                            <img src="{{$post->getNextImage()}}" alt="">

                                            <div class="overlay">

                                                <div class="promo-text">
                                                    <p><i class=" pull-left fa fa-angle-left"></i></p>
                                                    <h5>{{$post->getNextTitle()}}</h5>
                                                </div>
                                            </div>
                    ...
                    <div class="bottom-comment"><!--bottom comment-->
                        ...
                        <div class="comment-img">
                            <img class="img-circle" height="70px" width="70x" src="{{$comment->user->getAvatar()}}" alt="">
                        </div>
                    ...
                    {{Form::open(['route'=>['comment.store'],'class'=>'form-horizontal contact-form','role'=>'form'])}}
                            ...
                            <button type="submit" href="#" class="btn send-btn">Post Comment</button>
                        {{Form::close()}}
